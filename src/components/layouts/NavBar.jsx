...
function NavBar() {
  return (
    <nav className="w-[80%] sm:w-[80%] md:w-[85%] lg:w-[65%] bg-[#f4a831] mt-4 mb-4 rounded-xl p-1 max-w-[850px] md:max-h-[50px] lg:max-h-[50px] justify-self-center sm:justify-self-center md:justify-self-auto ld:justify-self-auto">
